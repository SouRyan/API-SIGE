...
namespace API.SIGE.Migrations
{
    ...
    [Migration("20260330234140_UsuarioFkCargoRemoveUsuarioCargo")]
    partial class UsuarioFkCargoRemoveUsuarioCargo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.SIGE.Model.Obra", b =>
                {
                    b.HasOne("API.SIGE.Model.Usuario", "ResponsavelMedicao")
                        .WithMany()
                        .HasForeignKey("IdResponsavelMedicao")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("API.SIGE.Model.Usuario", "ResponsavelProducao")
                        .WithMany()
                        .HasForeignKey("IdResponsavelProducao")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("API.SIGE.Model.Usuario", "ResponsavelVerificacao")
                        .WithMany()
